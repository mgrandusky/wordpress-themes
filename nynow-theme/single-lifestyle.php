...
<div id="main" class="cf">
    <div id="content">
		...
		<article class="hentry collections">
            <a href="<?php bloginfo('siteurl'); ?>/collections/lifestyle" style="text-decoration:none;"><h2 class="entry-title">Lifestyle</h2></a>
            <h3><?php the_title(); ?></h3>
            <div style="float: right; margin: 0 0 0 10px;">
                <div style="background-color: #e0dddb; display: inline-block; width: 312px; padding: 24px 20px 10px 20px; margin-bottom:15px;">
                    ...
                    <p><?php echo the_field('contact_title'); ?>: <a href="<?php echo the_field('contact_email'); ?>"><?php echo the_field('contact_name'); ?></a></p>
                </div>
