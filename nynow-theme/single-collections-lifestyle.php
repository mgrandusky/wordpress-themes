<?php
/*
Template Name Posts: Collection Lifestyle
*/
?>
...
<div id="main" class="cf">
    <div id="content">
		...
		<article class="hentry collections">
            <a href="<?php bloginfo('siteurl'); ?>/collections/lifestyle" style="text-decoration:none;"><h2 class="entry-title"><?php the_title(); ?></h2></a>
            <?php the_content(); ?>

			<?php $args = array( 'post_type' => 'lifestyle');
