...
Template Name Posts: Tech Clinc
	          ...
	          <li>
				...
				// var_dump($_REQUEST);
					...
					if($_REQUEST['exhibitorlist-search'] != ""){
						...
						$section .= "and type like 'Tech Clinic' ";
						} else {
							$section .= "where type like 'Tech Clinic' ";
						}
...
$(document).on('click','.reset',function(){
							window.location.href = "http://wpdev.emeraldexpo.com/interbike/conference/tech-clinics/";
							return false; 
						})
</script>
