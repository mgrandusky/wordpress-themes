    ...
    <li>   
      <div class="el-firstrow clearfix">
            <a name="javascript:void(0)">
                ...
                <span class="el-boothNum"><?= $row['booth_id']; ?>
                <?php if($row['enhanced']){ ?>
											<div style="width:17px;float:right;font-weight: 400;"><img src="http://www.interbike.com/wp-content/themes/interbike-theme/images/ico_enhanced.png"></div>
                                            
										<?php }else{ ?>
											<div style="width:17px;float:right;font-weight: 400;"></div>
										<?php }
        ...
        <div class="el-detail clearfix">
          ...
          <div class="el-rightCol three-fourth">
            <p>Contact: <?= $row['contact_name']; ?><br/>
              ...
              <span class="el-link">
              <!--a href="mailto:<?= $row['contact_email']; ?>"><strong>Email</strong></a>&nbsp;&nbsp;-->
              <a href="<?= $row['contact_website']; ?>" target="_blank"><strong>Website</strong></a></span>
              </p>
              <p>Booth: <?= $row['booth_id']; ?><br/>
              Categories: <?= $row['category']; ?></p>
              <p><span class="el-link"><a href="https://n1b.goexposoftware.com/events/ib16/goExpo/exhibitor/viewExhibitorProfile.php?__id=<?= $row['__id']; ?>" target="_blank">More Information &raquo;</a></span></p>
           </div>   
