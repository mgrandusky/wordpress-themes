...
function show_links($device = null){
	$irceoptions = pods( 'irceoptions', $params );
  ?>
  <div class="quicklinks clearfix" style="display:none;">
    
	<a class="attend" href="<?php echo $irceoptions->field( 'register_now_url' ); ?>" target="_blank">Register to Attend</a> 
	<a class="exhibit" href="<?= bloginfo('siteurl') ?>/exhibitors/exhibit-inquire/" >Exhibit / Inquire</a> 
	<a href="<?php echo $irceoptions->field( 'conferencing_pricing_url' ); ?>" class="conference"><span>Event Pricing</span></a>
	<div class="exhibitor-list" style="margin:0px;">
		<!-- 
        <a href="<?php echo $irceoptions->field( 'exhibitor_list_url' ); ?>" target="_blank">Exhibitor List</a>/
        <a href="<?php echo $irceoptions->field( 'floor_plan_url' ); ?>" target="_blank">Floor Plan</a> 
        //-->
		<a href="<?php echo $irceoptions->field( 'exhibitor_list_url' ); ?>" target="_blank">Exhibitor List</a>/<a href="<?php echo $irceoptions->field( 'floor_plan_url' ); ?>" target="_blank">Floor Plan</a>
	</div>  
  </div> 
   <div class="quicklinks clearfix">
    <div class="register-exhibit">
        <h6><?php echo $irceoptions->field( 'sidebar_text' ); ?></h6>
        <a class="attend" href="<?php echo $irceoptions->field( 'register_now_url' ); ?>" target="_blank">Register Today</a> 
        <a class="exhibit" href="<?= bloginfo('siteurl') ?>/exhibitors/exhibit-inquire/" >Exhibit / Inquire</a> 
    </div>
    <!-- a class="conference" href="<?php echo $irceoptions->field( 'conferencing_pricing_url' ); ?>" ><span>Conference Pricing</span></a -->
    <a class="exhibitor-list" href="<?php echo $irceoptions->field( 'exhibitor_list_url' ); ?>" target="_blank"><span>Exhibitor List </span></a>
    <a class="floor-plan" href="<?php echo $irceoptions->field( 'floor_plan_url' ); ?>" target="_blank"><span> / Floor Plan</span></a>
  </div>
