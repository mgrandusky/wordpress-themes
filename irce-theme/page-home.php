...
            </li>
            ...
            <li class="hp-sponsor">
              ...
              <h1><a href="<?php the_field('featured_sponsor_link'); ?>">Title Sponsors</a></h1>
...
$rss = fetch_feed('https://www.digitalcommerce360.com/vertical/internet-retailer/feed/');
...
?>
    ...
    <?php else : ?>
		...
		<p><?php echo strip_tags( $item->get_description() ); ?><br><a href="<?php echo esc_url( $item->get_permalink() ); ?>" class="readmore-bold" target="_blank">Read more &raquo;</a></p>
        <?php endforeach; ?>
    <?php endif; ?>
