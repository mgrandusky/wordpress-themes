  ...
  <main class="container">
    <div id="content" class="col-lg-9">
      <section>
        ...
        <h1 class="entry-title">Screen Printing: <?php echo get_the_term_list( $post->ID, 'screen-printing-categories', '', ', ', '' ) ?><hr></h1><br>
...
<?php wp_reset_query(); ?>
        ...
        <div class="more-posts">
          <h2>More <?php echo get_the_term_list( $post->ID, 'screen-printing-categories', '', ', ', '' ) ?> News</h2>
          <hr>
          <br>
...
<?php
				...
				$args = array(
	'posts_per_page' => 4,
	'post_type' => 'screen-printing', 
	'tax_query' => array(
		array(
			'taxonomy' => 'screen-printing-categories',
			'field'    => 'name',
			'terms'    => get_the_term_list( $ID, 'screen-printing-categories', '', ', ', '' ),
		),
	),
...
while ( $query->have_posts() ) : $query->the_post();
 ...
 <?php if(get_field('abstract_image') || get_field('article_image')): ?>
			...
			<?php endif; ?>
              ...
              <span class="meta"><i><?php echo get_the_date(); ?> <?php if (get_the_term_list( $ID, 'screen-printing-categories', '', ', ', '' )): ?>| <?php echo get_the_term_list( $ID, 'screen-printing-categories', '', ', ', '' ) ?><?php endif; ?></i></span>
