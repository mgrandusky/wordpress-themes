  ...
  <main class="container">
    <div id="content" class="col-lg-9">
      <section>
        ...
        <h1 class="entry-title">News: <?php echo get_the_term_list( $post->ID, 'news-categories', '', ', ', '' ) ?><hr></h1><br>
...
<?php wp_reset_query(); ?>
        ...
        <div class="more-posts">
          <h2>More <?php echo get_the_term_list( $post->ID, 'news-categories', '', ', ', '' ) ?> News</h2>
          <hr>
          <br>
...
<?php
	...
	'tax_query' => array(
		array(
			...
			'field'    => 'name',
			'terms'    => get_the_term_list( $ID, 'news-categories', '', ', ', '' ),
		),
	),
...
while ( $query->have_posts() ) : $query->the_post();
 ...
 <article>
			...
			<?php endif; ?>
              ...
              <span class="meta"><i><?php echo get_the_date(); ?> <?php if (get_the_term_list( $ID, 'news-categories', '', ', ', '' )): ?>| <?php echo get_the_term_list( $ID, 'news-categories', '', ', ', '' ) ?><?php endif; ?></i></span>
