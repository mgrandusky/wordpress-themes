  ...
  <main class="container">
    <div id="content" class="col-lg-9">
      <section>
        ...
        <h1 class="entry-title">Embroidery: <?php echo get_the_term_list( $post->ID, 'embroidery-categories', '', ', ', '' ) ?><hr></h1><br>
...
<?php wp_reset_query(); ?>
        ...
        <div class="more-posts">
          <h2>More <?php echo get_the_term_list( $post->ID, 'embroidery-categories', '', ', ', '' ) ?> News</h2>
          <hr>
          <br>
...
<?php
	...
	'tax_query' => array(
		array(
			...
			'field'    => 'name',
			'terms'    => get_the_term_list( $ID, 'embroidery-categories', '', ', ', '' ),
		),
	),
