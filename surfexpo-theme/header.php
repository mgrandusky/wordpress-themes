...
<head>
	...
	<link rel="shortcut icon" href="Surf_Expo_Flavicon.png" />
...
<!-- End Google Tag Manager -- Photo Plus Expo -->
	...
	<div class="header-container">
	  <header class="wrapper clearfix">
	    ...
	    <h4 class="two-fifths date-image">
	    	<span class="dates"><?php the_field('header_date', 'option'); ?></span>
	    	<span class="demo-day"><?php the_field('header_demo_day', 'option'); ?></span>
	    	<span class="location"><?php the_field('header_location', 'option'); ?></span>
	    </h4> 
	    <!-- Start Social -->
	    <?php display_social(); ?>
	    <!-- End Social --> 
