  ...
  <div class="container" id="main">
	  ...
	  <div class="fluid-width">	
		<div class="inner-block row">
	         ...
	         <section> 
				<h1 class="header top">Departments</h1>  
...
?>
    	        ...
    	        <article class="row">
					...
					<p class="img300-fl"><a href="<?= post_permalink( $ID ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/content-images/default_300.png"></a></p>
                	   ...
                	   <p class="date row"><?php echo get_the_date(); ?> <?php if (get_the_term_list( $ID, 'departments-categories', '', ', ', '' )): ?>| <span style="text-transform:uppercase;color:red;"><?php echo get_the_term_list( $ID, 'departments-categories', '', ', ', '' ) ?></span><?php endif; ?></p>
