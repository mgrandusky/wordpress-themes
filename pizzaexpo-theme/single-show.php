...
<div id="main" class="container">
    ...
    <div id="content" class="col-md-8 col-sm-7">
        ...
        <?php 
        if(is_single('show-sponsors')) { ?>
            <div style="display:none;">
                <?php get_template_part('inc/sponsor'); ?>
            </div>
        <?php } ?>
        ...
        <?php if(is_single('EDUCATION SCHEDULE')){ ?>
            ...
            <!-- BEGIN: GOEXPO SEMINARS -->
                ...
                <script type="text/javascript" src="https://n1b.goexposoftware.com/events/pe16/goExpo/public/printIframeNew.js"></script>
            <!-- END: GOEXPO SEMINARS -->
            </center>
        <?php } ?>
